...
const FEED_FREQ = process.env.FEED_FETCH_FREQ_MS ? parseInt(process.env.FEED_FETCH_FREQ_MS) : 5 * 60 * 1000; // 5 min default
const SUMMARIZE_FREQ = process.env.SUMMARIZE_FREQ_MS ? parseInt(process.env.SUMMARIZE_FREQ_MS) : 30 * 60 * 1000; // 30 min default
